...
#define I2C_0 DEVICE_DT_NAME(DT_NODELABEL(i2c0))
#define I2C_1 DEVICE_DT_NAME(DT_NODELABEL(i2c1))
#define I2C_2 DEVICE_DT_NAME(DT_NODELABEL(i2c2))
#define I2C_3 DEVICE_DT_NAME(DT_NODELABEL(i2c3))
#define I2C_4 DEVICE_DT_NAME(DT_NODELABEL(i2c4))
#define I2C_5 DEVICE_DT_NAME(DT_NODELABEL(i2c5))
#define I2C_6 DEVICE_DT_NAME(DT_NODELABEL(i2c6))
#define I2C_7 DEVICE_DT_NAME(DT_NODELABEL(i2c7))
#define I2C_8 DEVICE_DT_NAME(DT_NODELABEL(i2c8))
#define I2C_9 DEVICE_DT_NAME(DT_NODELABEL(i2c9))
#define I2C_10 DEVICE_DT_NAME(DT_NODELABEL(i2c10))
#define I2C_11 DEVICE_DT_NAME(DT_NODELABEL(i2c11))
#define I2C_12 DEVICE_DT_NAME(DT_NODELABEL(i2c12))
#define I2C_13 DEVICE_DT_NAME(DT_NODELABEL(i2c13))
#define I2C_14 DEVICE_DT_NAME(DT_NODELABEL(i2c14))
#define I2C_15 DEVICE_DT_NAME(DT_NODELABEL(i2c15))
